...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("state", sa.String(), nullable=True),
        sa.Column("blue_kills", sa.Integer(), nullable=False),
        sa.Column("blue_towers", sa.Integer(), nullable=False),
        sa.Column("blue_barons", sa.Integer(), nullable=False),
        sa.Column("blue_inhibitors", sa.Integer(), nullable=False),
        sa.Column("blue_gold", sa.Integer(), nullable=False),
        sa.Column("blue_dragons", sa.JSON(), nullable=True),
        sa.Column("red_kills", sa.Integer(), nullable=False),
        sa.Column("red_towers", sa.Integer(), nullable=False),
        sa.Column("red_barons", sa.Integer(), nullable=False),
        sa.Column("red_inhibitors", sa.Integer(), nullable=False),
